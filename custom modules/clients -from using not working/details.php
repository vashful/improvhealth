...
class Module_Clients extends Module {
	...
	public function info()
	{
		return array(
			...
			'description' => array(
				'en' => 'Let clients register and manage them via the control panel.',
	...
	public function help()
	{
		...
		<p>The Clients module works together with Groups and Permissions to give PyroCMS access control.</p>
		<h4>Add a User</h4><hr>
		...
		<h4>Activating New Clients</h4><hr>
		<p>If activation emails are disabled in Settings clients that register on the website front-end will appear under the Inactive Clients
		menu item until you either approve or delete their account. If activation emails are enabled clients may register silently, without an admin's help.</p>";
	}
}
