(function($) {
	$(function(){
		...
		$('#client-address-tab ul li:eq(2) a').colorbox({
			   srollable: false,
			innerWidth: 600,
			innerHeight: 280,
		...
		$('#client-address-tab ul li:eq(3) a').colorbox({
			   srollable: false,
			innerWidth: 600,
			innerHeight: 280,
			...
			onComplete: function() {
				...
				$('#client-address-tab ul li:eq(4) a').colorbox({
			   srollable: false,
			innerWidth: 600,
			innerHeight: 280,
			...
			onComplete: function() {
				...
				$('#client-address-tab ul li:eq(5) a').colorbox({
			   srollable: false,
			innerWidth: 600,
			innerHeight: 280,
