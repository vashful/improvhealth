<?php if ($this->method == 'edit'): ?>
	<section class="title">
    	<h4><?php echo sprintf(lang('clients.edit_title'), $group->name); ?></h4>
	</section>
<?php else: ?>
	<section class="title">
    	<h4><?php echo lang('clients.add_title'); ?></h4>
	</section>
<?php endif; ?>
...
<div class="form_inputs">
    ...
    <ul>
		<li>
			<label for="description"><?php echo lang('clients.name');?> <span>*</span></label>
			<div class="input"><?php echo form_input('description', $group->description);?></div>
		</li>
		
		<li class="even">
			<label for="name"><?php echo lang('clients.short_name');?> <span>*</span></label>
