...
class Admin extends Admin_Controller 
{
	...
	{
		parent::__construct();
        $this->load->model(array('clients/clients_m', 'clients/clients_region_m', 'clients/clients_province_m', 'clients/clients_city_m', 'clients/clients_barangay_m','consultations/consultations_m','settings/settings_m','bhs_m1/bhs_m1_m'));
    ...
    {           
        ...
        if($action=="generate_bhs_m1_dl")  
            {$this->fpdf->Output('BHS_M1_'.url_title($bhs_bhc).'_'.$monthname.'_'.$year.'.pdf','D');} 
        else
            {$this->fpdf->Output('BHS_M1_'.url_title($bhs_bhc).'_'.$monthname.'_'.$year.'.pdf','I');}            
    ...
    function m1_header_icon()
    {
        ...
        $this->fpdf->Cell(45,15,'BHS',0,1,'C');
    }
