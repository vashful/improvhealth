...
class Module_Family extends Module {
	...
	public function info()
	{
	    ...
	    'shortcuts' => array(
						array(
					 	   'name' => 'family.add_title',
						    'uri' => 'admin/family/add_client',
						    'class' => 'add'
						),
					), 
			'sections' => array(
          'mylist' => array(
						array(
					 	   'name' => 'Add New FP Record for this Client',
						    'uri' => 'admin/family/add',
						    'class' => 'add'
						),
						array(
