 ...
 *
 * @package		BHS
 * @subpackage	City Module
 * @category	Modules
 * @author		Ronald Rhey P. Minoza - Kobusoft
 */
class Clients_city_m extends MY_Model
{
	/**
	...
	*/
	public function get_name($id)
	{
		if(!$id)
		return;
    $query = $this->db->query("SELECT name FROM default_clients_cities where id = $id LIMIT 1");
		$row = $query->row_array();
    return $row['name'];
	}
	...
	{
		return parent::count_by('name', $city) > 0;
	}
