      ...
      <?php echo form_open(uri_string().'/show', 'class="crud" target="_blank"'); ?>
        <tr> 
            <td><strong>BHS M2</strong></td>
					  <td class="align-center"><?php echo form_dropdown('bhs_m2_month', $months, date("m"), 'id="bhs_m2_month" class="chznsm"') ?> <?php echo form_dropdown('bhs_m2_year', $years, date("Y"), 'id="bhs_m2_year" class="chznsm"') ?></td>
