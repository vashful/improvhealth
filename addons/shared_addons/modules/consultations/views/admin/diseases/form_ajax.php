...
<div class="form_inputs">
    ...
    <li class="even">
		...
		<div class="input">
    				<?php echo form_dropdown('category', array('0' => 'Other Category', '1' => 'Category I(Immediately Notifiable)', '2' => 'Category II(Weekly Notifiable)', '3' => 'Non-Disease' ), $diseases->category, ''); ?>
    </div>
		</li>
	</ul>
