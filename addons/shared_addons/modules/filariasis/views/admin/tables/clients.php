			...
			<table border="0" class="table-list">
	          ...
	          <th class="collapse">Remarks</th>     
				...
				<tbody>
					<?php foreach ($clients as $client): ?>
						<tr>
							<td class="align-center"><?php echo form_checkbox('action_to[]', $client->filariasis_id); ?></td>
              ...
              <td class="collapse"><?php echo $client->remarks; ?>&nbsp;</td>
							<td class="actions" style="text-align: center">
								<?php echo anchor('admin/filariasis/edit/' . $client->filariasis_id, lang('global:edit'), array('class'=>'button edit')); ?>
								<?php echo anchor('admin/filariasis/delete/' . $client->filariasis_id, lang('global:delete'), array('class'=>'confirm button delete')); ?>
							</td>
							</tr>
					<?php endforeach; ?>
				</tbody>
