...
<section class="item">
	...
	<?php if ( ! empty($tables)): ?>
      ...
      <?php echo form_open(uri_string().'/show', 'class="crud" target="_blank"'); ?>
        <tr> 
            <td><strong>BHS M2</strong></td>
			     <td class="align-center"><?php echo form_dropdown('m2_brgy',  array(0 =>'-- All --') + $barangays, 0, 'id="m2_brgy" class="chzn"'); ?></td>
                 <td class="align-center"><?php echo form_dropdown('m2_month', $months, date("m"), 'id="m2_month" class="chznsm"') ?> <?php echo form_dropdown('m2_year', $years, date("Y"), 'id="m2_year" class="chznsm"') ?></td>
