...
class Admin extends Admin_Controller 
{
	...
	{
		parent::__construct();
        $this->load->model(array('clients/clients_m', 'clients/clients_region_m', 'clients/clients_province_m', 'clients/clients_city_m', 'clients/clients_barangay_m','consultations/consultations_m','settings/settings_m','bhs_m2/bhs_m2_m','brgy_m2/brgy_m2_m'));
    ...
    public function bhs_m2()
    {
        ...
        $month = $this->input->post('m2_month');
        $year = $this->input->post('m2_year');
        $brgy = $this->input->post('m2_brgy'); 
        ...
        $this->bhs_m2_morbidity($month,$year,$brgy);
        
        if($action=="generate_bhs_m2_dl")  
            {$this->fpdf->Output('Brgy_M2_'.$bhs_bhc.'_'.$monthname.'_'.$year.'.pdf','D');}
        else
            {$this->fpdf->Output('Brgy_M2_'.$bhs_bhc.'_'.$monthname.'_'.$year.'.pdf','I');}
    }
    
    function bhs_m2_morbidity($month,$year,$brgy)
    {               
        if($month==1)
            {$monthname="January";}
        elseif($month==2)
        ...
        { 
            $morbidity_cases_under1 = $this->brgy_m2_m->get_morbidity_cases_under1($month, $year, $brgy);
            $morbidity_cases_1to4 = $this->brgy_m2_m->get_morbidity_cases_1to4($month, $year, $brgy);
            $morbidity_cases_5to9 = $this->brgy_m2_m->get_morbidity_cases_5to9($month, $year, $brgy);
            $morbidity_cases_10to14 = $this->brgy_m2_m->get_morbidity_cases_10to14($month, $year, $brgy);
            $morbidity_cases_15to19 = $this->brgy_m2_m->get_morbidity_cases_15to19($month, $year, $brgy);
            $morbidity_cases_20to24 = $this->brgy_m2_m->get_morbidity_cases_20to24($month, $year, $brgy);
            $morbidity_cases_25to29 = $this->brgy_m2_m->get_morbidity_cases_25to29($month, $year, $brgy);
            $morbidity_cases_30to34 = $this->brgy_m2_m->get_morbidity_cases_30to34($month, $year, $brgy);
            $morbidity_cases_35to39 = $this->brgy_m2_m->get_morbidity_cases_35to39($month, $year, $brgy);
            $morbidity_cases_40to44 = $this->brgy_m2_m->get_morbidity_cases_40to44($month, $year, $brgy);
            $morbidity_cases_45to49 = $this->brgy_m2_m->get_morbidity_cases_45to49($month, $year, $brgy);
            $morbidity_cases_50to54 = $this->brgy_m2_m->get_morbidity_cases_50to54($month, $year, $brgy);
            $morbidity_cases_55to59 = $this->brgy_m2_m->get_morbidity_cases_55to59($month, $year, $brgy);
            $morbidity_cases_60to64 = $this->brgy_m2_m->get_morbidity_cases_60to64($month, $year, $brgy);
            $morbidity_cases_65up = $this->brgy_m2_m->get_morbidity_cases_65up($month, $year, $brgy);
            $morbidity_cases_total = $this->brgy_m2_m->get_morbidity_cases_total($month, $year, $brgy);
        }
        ...
        $this->m2_header($month,$year,$brgy);
    ...
    function m2_header($month,$year,$brgy)
    {
        ...
        {
            $barangay = $this->brgy_m2_m->get_brgy_name($brgy);
        ...
        $this->fpdf->SetX(110);
        $this->fpdf->Cell(29,5,'Name of Barangay:',0,0,'L');
        $this->fpdf->Cell(50,5,$barangay,'ltrB',1,'C');
        $this->fpdf->SetX(110);
    ...
    function m2_header_icon()
    {
        ...
        $this->fpdf->Cell(30,10,'BRGY',0,1,'C');
    }
