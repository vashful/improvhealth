...
<section class="title">
    <?php if ($sc->method_action == 'add'): ?>
    		<h4>Add <em>"<?php echo $client->last_name; ?>, <?php echo $client->first_name; ?>"</em> as a Leprosy Client</h4>
    		<?php echo form_open(uri_string(), 'class="crud" autocomplete="off"'); ?>
       	<?php else: ?>
    		<h4><?php echo sprintf('Edit Leprosy Client "%s"', $client->first_name);?></h4>
	...
	<div class="tabs">
		...
		<div class="form_inputs" id="client-vitamin-tab">
          ...
          <li class="even">
					...
					<li>
    				<label for="date_given">Date of Diagnosis/Findings</label>
    				<div class="input">
