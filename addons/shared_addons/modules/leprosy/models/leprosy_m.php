 ...
 *
 */
class Leprosy_m extends MY_Model
{
	/**
	...
	public function insert($input = array())
	{
                ...
                {                
                  ...
                  $this->db->insert('leprosy', $data); 

                  $leprosy_id = $this->db->insert_id();
                }
                else
                {
                  return false;
	...
	{
		$this->db->delete('leprosy', array('id' => $id)); 								
		return true;
	}
    ...
    $this->db->from('leprosy');
    $this->db->join('clients', 'clients.id = leprosy.client_id');
    ...
    public function count_rows_on_table($table = 'leprosy', $field = 'id' ,$value = 0)
    {
    ...
    {
        $this->db->select('*, leprosy.id as leprosy_id');
        $this->db->from('leprosy');
        $this->db->join('clients', 'clients.id = leprosy.client_id');
    ...
    public function get_leprosy_details($id = null)
    {
          $this->db->select('*, leprosy.id as leprosy_id');
          $this->db->from('leprosy');
      		$this->db->where('leprosy.id', $id);
