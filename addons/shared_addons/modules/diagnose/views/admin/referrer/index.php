...
<section class="item">
	...
	<?php if ($referrer): ?>
		...
		<?php echo form_open('admin/diagnose/referrer/delete'); ?>
			...
			<tbody>
				...
				<tr>
					...
					<td class="align-center buttons buttons-small">
						<?php echo anchor('admin/diagnose/referrer/edit/' . $referrer->id, lang('global:edit'), 'class="button edit"'); ?>
						<?php echo anchor('admin/diagnose/referrer/delete/' . $referrer->id, lang('global:delete'), 'class="confirm button delete"') ;?>
					</td>
				</tr>
				<?php endforeach; ?>
			</tbody>
