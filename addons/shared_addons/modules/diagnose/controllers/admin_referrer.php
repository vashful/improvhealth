...
class Admin_Referrer extends Admin_Controller {
	...
	public function create()
	{
		...
		if ($this->form_validation->run())
		{
			...
			redirect('admin/diagnose/referrer');
		}
	...
	{	
		...
		// ID specified?
		$referrer or redirect('admin/diagnose/referrer/index');
		...
		{		
			...
			redirect('admin/diagnose/referrer/index');
		}
	...
	public function create_ajax()
	{
		...
		if ($this->form_validation->run())
		{
			...
			if ($id > 0)
			{
				$message = sprintf( 'Referrer "%d" Successfully Added', $this->input->post('title'));
			}
			else
			{
				$message = 'Error Adding Referrer';
			}
		...
		{
			// Render the view
			$form = $this->load->view('admin/referrer/form', $this->data, TRUE);
