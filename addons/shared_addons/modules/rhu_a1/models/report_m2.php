...
class Report_m2 extends MY_Model
{
    ...
    {       
        ...
        SELECT
          ...
          ( SELECT count(*) FROM default_sc b JOIN default_sc_vitamin_a c ON b.id = c.sc_id JOIN default_clients a ON b.client_id = a.id where a.gender = 'female' and  (MONTH(FROM_UNIXTIME(b.date_added)) = $m and YEAR(FROM_UNIXTIME(b.date_added)) = $y)) as child_sick_611_F_total,
        	( SELECT count(*) FROM default_sc b JOIN default_sc_vitamin_a c ON b.id = c.sc_id JOIN default_clients a ON b.client_id = a.id where a.gender = 'male' and (MONTH(FROM_UNIXTIME(b.date_added)) = $m and YEAR(FROM_UNIXTIME(b.date_added)) = $y)) as child_sick_611_M_total,
        	( SELECT count(*) FROM default_sc b JOIN default_sc_vitamin_a c ON b.id = c.sc_id JOIN default_clients a ON b.client_id = a.id where a.gender = 'female' and (MONTH(FROM_UNIXTIME(b.date_added)) = $m and YEAR(FROM_UNIXTIME(b.date_added)) = $y)) as child_sick_1259_F_total,        	
          ( SELECT count(*) FROM default_sc b JOIN default_sc_vitamin_a c ON b.id = c.sc_id JOIN default_clients a ON b.client_id = a.id where a.gender = 'male' and (MONTH(FROM_UNIXTIME(b.date_added)) = $m and YEAR(FROM_UNIXTIME(b.date_added)) = $y)) as child_sick_1259_M_total,
          ( SELECT count(*) FROM default_sc b JOIN default_sc_vitamin_a c ON b.id = c.sc_id JOIN default_clients a ON b.client_id = a.id where a.gender = 'female' and (MONTH(FROM_UNIXTIME(b.date_added)) = $m and YEAR(FROM_UNIXTIME(b.date_added)) = $y)) as child_sick_6079_F_total,
        	( SELECT count(*) FROM default_sc b JOIN default_sc_vitamin_a c ON b.id = c.sc_id JOIN default_clients a ON b.client_id = a.id where a.gender = 'male' and (MONTH(FROM_UNIXTIME(b.date_added)) = $m and YEAR(FROM_UNIXTIME(b.date_added)) = $y) ) as child_sick_6079_M_total,
          
          ( SELECT count(*) FROM default_sc b JOIN default_sc_vitamin_a c ON b.id = c.sc_id JOIN default_clients a ON b.client_id = a.id where a.gender = 'female' and c.six_months = 1 and (c.diagnosis='A' or c.diagnosis='B' and c.diagnosis='C' and c.diagnosis='D' and c.diagnosis='E' and c.diagnosis='F' and c.diagnosis='G' and c.diagnosis='H' and c.diagnosis='I' and c.diagnosis='J') and  (MONTH(FROM_UNIXTIME(b.date_added)) = $m and YEAR(FROM_UNIXTIME(b.date_added)) = $y)) as child_sick_611_vitA_F_total,
        	( SELECT count(*) FROM default_sc b JOIN default_sc_vitamin_a c ON b.id = c.sc_id JOIN default_clients a ON b.client_id = a.id where a.gender = 'male' and c.six_months = 1 and (c.diagnosis='A' or c.diagnosis='B' and c.diagnosis='C' and c.diagnosis='D' and c.diagnosis='E' and c.diagnosis='F' and c.diagnosis='G' and c.diagnosis='H' and c.diagnosis='I' and c.diagnosis='J') and (MONTH(FROM_UNIXTIME(b.date_added)) = $m and YEAR(FROM_UNIXTIME(b.date_added)) = $y)) as child_sick_611_vitA_M_total,
        	( SELECT count(*) FROM default_sc b JOIN default_sc_vitamin_a c ON b.id = c.sc_id JOIN default_clients a ON b.client_id = a.id where a.gender = 'female' and c.twelve_months = 1 and (c.diagnosis='A' or c.diagnosis='B' and c.diagnosis='C' and c.diagnosis='D' and c.diagnosis='E' and c.diagnosis='F' and c.diagnosis='G' and c.diagnosis='H' and c.diagnosis='I' and c.diagnosis='J') and (MONTH(FROM_UNIXTIME(b.date_added)) = $m and YEAR(FROM_UNIXTIME(b.date_added)) = $y)) as child_sick_1259_vitA_F_total,        	
          ( SELECT count(*) FROM default_sc b JOIN default_sc_vitamin_a c ON b.id = c.sc_id JOIN default_clients a ON b.client_id = a.id where a.gender = 'male' and c.twelve_months = 1 and (c.diagnosis='A' or c.diagnosis='B' and c.diagnosis='C' and c.diagnosis='D' and c.diagnosis='E' and c.diagnosis='F' and c.diagnosis='G' and c.diagnosis='H' and c.diagnosis='I' and c.diagnosis='J') and (MONTH(FROM_UNIXTIME(b.date_added)) = $m and YEAR(FROM_UNIXTIME(b.date_added)) = $y)) as child_sick_1259_vitA_M_total,
          ( SELECT count(*) FROM default_sc b JOIN default_sc_vitamin_a c ON b.id = c.sc_id JOIN default_clients a ON b.client_id = a.id where a.gender = 'female' and c.sixty_months = 1 and (c.diagnosis='A' or c.diagnosis='B' and c.diagnosis='C' and c.diagnosis='D' and c.diagnosis='E' and c.diagnosis='F' and c.diagnosis='G' and c.diagnosis='H' and c.diagnosis='I' and c.diagnosis='J') and (MONTH(FROM_UNIXTIME(b.date_added)) = $m and YEAR(FROM_UNIXTIME(b.date_added)) = $y)) as child_sick_6079_vitA_F_total,
        	( SELECT count(*) FROM default_sc b JOIN default_sc_vitamin_a c ON b.id = c.sc_id JOIN default_clients a ON b.client_id = a.id where a.gender = 'male' and c.sixty_months = 1 and (c.diagnosis='A' or c.diagnosis='B' and c.diagnosis='C' and c.diagnosis='D' and c.diagnosis='E' and c.diagnosis='F' and c.diagnosis='G' and c.diagnosis='H' and c.diagnosis='I' and c.diagnosis='J') and (MONTH(FROM_UNIXTIME(b.date_added)) = $m and YEAR(FROM_UNIXTIME(b.date_added)) = $y)) as child_sick_6079_vitA_M_total
    ...
    {       
        $query = $this->db->query("
        SELECT               
          ( SELECT count(*) FROM default_sc b JOIN default_sc_vitamin_a c ON b.id = c.sc_id JOIN default_clients a ON b.client_id = a.id JOIN default_sc_anemic_children_iron d ON b.id = d.sc_id where a.gender = 'female' and (MONTH(FROM_UNIXTIME(d.date_started)) = $m and YEAR(FROM_UNIXTIME(d.date_started)) = $y) and (TIMESTAMPDIFF(MONTH, FROM_UNIXTIME(b.date_added), FROM_UNIXTIME(a.dob)) > 2 and TIMESTAMPDIFF(MONTH, FROM_UNIXTIME(b.date_added), FROM_UNIXTIME(a.dob)) <= 59) and (MONTH(FROM_UNIXTIME(b.date_added)) = $m and YEAR(FROM_UNIXTIME(b.date_added)) = $y)) as infant_26mos_lbw_F_total,
        	( SELECT count(*) FROM default_sc b JOIN default_sc_vitamin_a c ON b.id = c.sc_id JOIN default_clients a ON b.client_id = a.id JOIN default_sc_anemic_children_iron d ON b.id = d.sc_id where a.gender = 'male' and (MONTH(FROM_UNIXTIME(d.date_started)) = $m and YEAR(FROM_UNIXTIME(d.date_started)) = $y) and(TIMESTAMPDIFF(MONTH, FROM_UNIXTIME(b.date_added), FROM_UNIXTIME(a.dob)) > 2 and TIMESTAMPDIFF(MONTH, FROM_UNIXTIME(b.date_added), FROM_UNIXTIME(a.dob)) <= 59) and (MONTH(FROM_UNIXTIME(b.date_added)) = $m and YEAR(FROM_UNIXTIME(b.date_added)) = $y)) as infant_26mos_lbw_M_total,
        	( SELECT count(*) FROM default_sc b JOIN default_sc_vitamin_a c ON b.id = c.sc_id JOIN default_clients a ON b.client_id = a.id JOIN default_sc_anemic_children_iron d ON b.id = d.sc_id where a.gender = 'female' and (MONTH(FROM_UNIXTIME(d.date_started)) = $m and YEAR(FROM_UNIXTIME(d.date_started)) = $y) and(TIMESTAMPDIFF(MONTH, FROM_UNIXTIME(b.date_added), FROM_UNIXTIME(a.dob)) > 2 and TIMESTAMPDIFF(MONTH, FROM_UNIXTIME(b.date_added), FROM_UNIXTIME(a.dob)) <= 59) and (MONTH(FROM_UNIXTIME(b.date_added)) = $m and YEAR(FROM_UNIXTIME(b.date_added)) = $y)) as infant_26mos_lbw_iron_F_total,        	
          ( SELECT count(*) FROM default_sc b JOIN default_sc_vitamin_a c ON b.id = c.sc_id JOIN default_clients a ON b.client_id = a.id JOIN default_sc_anemic_children_iron d ON b.id = d.sc_id where a.gender = 'male' and (MONTH(FROM_UNIXTIME(d.date_started)) = $m and YEAR(FROM_UNIXTIME(d.date_started)) = $y) and(TIMESTAMPDIFF(MONTH, FROM_UNIXTIME(b.date_added), FROM_UNIXTIME(a.dob)) > 2 and TIMESTAMPDIFF(MONTH, FROM_UNIXTIME(b.date_added), FROM_UNIXTIME(a.dob)) <= 59) and (MONTH(FROM_UNIXTIME(b.date_added)) = $m and YEAR(FROM_UNIXTIME(b.date_added)) = $y)) as infant_26mos_lbw_iron_M_total
    ...
    {       
        $query = $this->db->query("
        SELECT                   
          ( SELECT count(*) FROM default_sc b JOIN default_sc_diarrhea_cases e ON b.id = e.sc_id JOIN default_clients a ON b.client_id = a.id where a.gender = 'female' and diarrhea_age < 59 and (MONTH(FROM_UNIXTIME(b.date_added)) = $m and YEAR(FROM_UNIXTIME(b.date_added)) = $y) and (MONTH(FROM_UNIXTIME(b.date_added)) = $m and YEAR(FROM_UNIXTIME(b.date_added)) = $y)) as diarrhea_059_F_total,
        	( SELECT count(*) FROM default_sc b JOIN default_sc_diarrhea_cases e ON b.id = e.sc_id JOIN default_clients a ON b.client_id = a.id where a.gender = 'male' and diarrhea_age < 59 and (MONTH(FROM_UNIXTIME(b.date_added)) = $m and YEAR(FROM_UNIXTIME(b.date_added)) = $y) and (MONTH(FROM_UNIXTIME(b.date_added)) = $m and YEAR(FROM_UNIXTIME(b.date_added)) = $y)) as diarrhea_059_M_total,
        	( SELECT count(*) FROM default_sc b JOIN default_sc_diarrhea_cases e ON b.id = e.sc_id JOIN default_clients a ON b.client_id = a.id where a.gender = 'female' and diarrhea_age < 59 and (MONTH(FROM_UNIXTIME(b.date_added)) = $m and YEAR(FROM_UNIXTIME(b.date_added)) = $y) and (MONTH(FROM_UNIXTIME(b.date_added)) = $m and YEAR(FROM_UNIXTIME(b.date_added)) = $y)) as diarrhea_059_F_total,        	
          ( SELECT count(*) FROM default_sc b JOIN default_sc_diarrhea_cases e ON b.id = e.sc_id JOIN default_clients a ON b.client_id = a.id where a.gender = 'male' and diarrhea_age < 59 and (MONTH(FROM_UNIXTIME(b.date_added)) = $m and YEAR(FROM_UNIXTIME(b.date_added)) = $y) and (MONTH(FROM_UNIXTIME(b.date_added)) = $m and YEAR(FROM_UNIXTIME(b.date_added)) = $y)) as diarrhea_059_M_total,
          ( SELECT count(*) FROM default_sc b JOIN default_sc_diarrhea_cases e ON b.id = e.sc_id JOIN default_clients a ON b.client_id = a.id where a.gender = 'female' and diarrhea_age < 59 and (MONTH(FROM_UNIXTIME(b.date_added)) = $m and YEAR(FROM_UNIXTIME(b.date_added)) = $y) and (MONTH(FROM_UNIXTIME(b.date_added)) = $m and YEAR(FROM_UNIXTIME(b.date_added)) = $y)) as diarrhea_059_F_total,
        	( SELECT count(*) FROM default_sc b JOIN default_sc_diarrhea_cases e ON b.id = e.sc_id JOIN default_clients a ON b.client_id = a.id where a.gender = 'male' and diarrhea_age < 59 and (MONTH(FROM_UNIXTIME(b.date_added)) = $m and YEAR(FROM_UNIXTIME(b.date_added)) = $y) and (MONTH(FROM_UNIXTIME(b.date_added)) = $m and YEAR(FROM_UNIXTIME(b.date_added)) = $y)) as diarrhea_059_M_total,
    ...
    public function get_maternal_quaterreport($q, $y)
    {
            if($q==1)
                {$between = "1 and 3";}
            elseif($q==2)
    ...
    public function get_dental_quaterreport($q, $y)
    {
            if($q==1)
                {$between = "1 and 3";}
            elseif($q==2)
