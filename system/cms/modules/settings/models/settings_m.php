...
class Settings_m extends MY_Model {
    ...
    public function get_default_province()
    {
        $this->db->select('value');
        $this->db->from('settings');     
        $this->db->where('slug','default_province');
    ...
    public function get_default_city()
    {
        $this->db->select('value');
        $this->db->from('settings');     
        $this->db->where('slug','default_city');
    ...
    public function get_station_name_default()
    {
        $this->db->select('value');
        $this->db->from('settings');     
        $this->db->where('slug','station_name');
