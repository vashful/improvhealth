...
class Maintenance_m extends MY_Model
{
   ...
   // Load the DB utility class
    $this->load->dbutil();
    $filename = url_title($this->settings->station_name, '_').'_'.date("mdy");
    $prefs = array(
                    'tables'      => array(),  // Array of tables to backup.
                    'ignore'      => array(),           // List of tables to omit from the backup
                    'format'      => 'zip',             // gzip, zip, txt
                    'filename'    => $filename.'_ImprovHealth.sql',    // File name - NEEDED ONLY WITH ZIP FILES
    ...
    force_download($filename.'_ImprovHealth.zip', $backup);
	}
  ...
  public function upload()
   ...
   // Load the DB utility class
    ...
    write_file($filename.'_ImprovHealth.zip', $backup); 
    ...
    $this->ftp->upload($filename.'_ImprovHealth.zip', $filename.'_ImprovHealth.zip');
    $this->ftp->close();
	}
